...
using ServiceStack.SakilaDb4oDemo.DataAccess.DataModel;

namespace ServiceStack.SakilaDb4oDemo.DataAccess
{
	public class SakilaDb4oDemoServiceDataAccessProvider
	{
		public SakilaDb4oDemoServiceDataAccessProvider(IPersistenceProvider provider)
		{
			Data = provider;
		}
