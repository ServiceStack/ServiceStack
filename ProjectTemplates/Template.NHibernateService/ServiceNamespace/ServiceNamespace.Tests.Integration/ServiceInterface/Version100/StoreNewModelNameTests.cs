...
{
	[TestFixture]
	public class StoreNew@ModelName@Tests : IntegrationTestBase
	{
		[Test]
		public void StoreNew@ModelName@Test()
		{
			//var requestDto = new Store@ModelName@ {
			...
			//Assert.That(responseDto.@ModelName@s[0].@ModelName@Name, Is.EqualTo(requestDto.@ModelName@Details.@ModelName@Name));
		}
	}
}