<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wsdl.aspx.cs" ContentType="text/xml" Inherits="@ServiceNamespace@.Host.WebService.Endpoints.Soap12.Metadata.Wsdl" 
...
<asp:Repeater id="repOneWayPortTypes" runat="server">
	...
	<wsdl:binding name="WSHttpBinding_ISyncReply" type="svc:ISyncReply">
        ...
        <asp:Repeater id="repReplyOperations" runat="server">
            <ItemTemplate>
            <wsdl:operation name="<%# Container.DataItem %>">
              <soap12:operation soapAction="http://services.ddnglobal.com/<%# Container.DataItem %>" style="document" />
              <wsdl:input>
