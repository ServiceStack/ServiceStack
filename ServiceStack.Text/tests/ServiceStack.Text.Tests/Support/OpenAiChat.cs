...
public class ChatCompletion
{
    ...
    public List<AiTools>? Tools { get; set; }
...
public class AiTextContent : AiContent
{
    ...
    public static List<AiContent> Create(string text)
    {
...
public class AiImageContent : AiContent
{
    ...
    public static List<AiContent> Create(string imageUrl, string? text = null)
    {
...
public class AiAudioContent : AiContent
{
    ...
    public static List<AiContent> Create(string data, string format="mp3", string? text = null)
    {
...
public class AiFileContent : AiContent
{
    ...
    public static List<AiContent> Create(string filename, string fileData, string? text = null)
    {
