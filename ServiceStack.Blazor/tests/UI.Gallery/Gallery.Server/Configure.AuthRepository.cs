...
public class ConfigureAuthRepository : IHostingStartup
{
    public void Configure(IWebHostBuilder builder) => builder
        ...
        .ConfigureAppHost(appHost => {
            ...
            CreateUser(authRepo, "manager@email.com", "The Manager", "p@55wOrd", roles: [AppRoles.Employee, AppRoles.Manager ]);
            CreateUser(authRepo, "employee@email.com", "A Employee", "p@55wOrd", roles: [AppRoles.Employee]);
