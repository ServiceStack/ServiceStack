...
public static class SelectInput
{
    public static string ErrorClasses { get; set; } = TextInput.ErrorClasses;
    public static string LabelClasses { get; set; } = TextInput.LabelClasses;
    public static string InputBaseClasses { get; set; } = "mt-1 block w-full pl-3 pr-10 py-2 text-base focus:outline-none border-gray-300 sm:text-sm rounded-md dark:text-white dark:bg-gray-900 dark:border-gray-600";
