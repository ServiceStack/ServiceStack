...
/// </summary>
public class AttributeValue(Tuple<string, int> prefix, Tuple<object, int> value, bool isLiteral)
{
    public Tuple<string, int> Prefix { get; private set; } = prefix;

    public Tuple<object, int> Value { get; private set; } = value;

    public bool IsLiteral { get; private set; } = isLiteral;
