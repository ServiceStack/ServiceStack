...
import { ApiFormSchema, JsonView, unwrapResponse } from "@servicestack/vue"
...
export const ApiExplorerSchema = {
    ...
    components: { ApiFormSchema, JsonView, CodeBlock, Teleport },
    props: {
    ...
    setup(props, { emit }) {
        ...
        return {
            schema, formSchema, result, tab, showCurl, maximized, formHeight,
            onSuccess, onError,
            schemaJson,
