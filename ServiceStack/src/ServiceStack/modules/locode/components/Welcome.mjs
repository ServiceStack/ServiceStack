    ...
    <div class="px-4">
        ...
        <div v-else>
            <div class="rounded-lg bg-white overflow-hidden shadow mb-3">
                ...
                <div v-if="store.authLinks.length" class="ml-3 mb-3 flex flex-wrap">
                    <a v-for="link in store.authLinks" :href="link.href"
                       class="mt-2 mr-3 inline-flex items-center px-6 py-3 border border-gray-300 shadow-sm md:text-lg font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
