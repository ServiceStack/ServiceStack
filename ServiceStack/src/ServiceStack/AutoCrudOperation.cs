...
public static class AutoCrudOperation
{
    ...
    public static bool IsOperation(string operation) => Crud.All.Contains(operation);
...
public struct AutoQueryDtoType
{
    ...
    public bool IsRead => Crud.Read.Contains(Operation);
    public bool IsWrite => Crud.Write.Contains(Operation);
