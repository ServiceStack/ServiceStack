...
public static class RsaUtils
{
    ...
    public static string Encrypt(this string text)
    {
        ...
        throw new ArgumentNullException("DefaultKeyPair", "No KeyPair given for encryption in RsaUtils");
    }
    ...
    public static string Decrypt(this string text)
    {
        ...
        throw new ArgumentNullException("DefaultKeyPair", "No KeyPair given for decryption in RsaUtils");
    }
