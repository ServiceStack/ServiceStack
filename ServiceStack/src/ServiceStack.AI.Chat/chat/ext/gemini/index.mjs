...
const GeminiHeader = {
    template: `
        <div data-tag="GeminiHeader" v-if="fileSearch" class="flex space-x-1 items-center cursor-pointer text-xs rounded transition-colors border custom-tooltip" :class="[$styles.tagLabel]"
            :data-title="fileSearch.title"
