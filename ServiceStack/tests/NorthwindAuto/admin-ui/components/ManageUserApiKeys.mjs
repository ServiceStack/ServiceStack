...
const EditApiKeyForm = {
                ...
                <div class="pt-3">
                  ...
                  <div class="p-4">
                    <fieldset>
                      <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                          <TextInput id="name" v-model="request.name" placeholder="Name of this API Key" />
                        </div>
                        <div class="col-span-6 sm:col-span-3">
    ...
    setup(props, { emit }) {
        ...
        return { server, css, request, expiresIn, scopes, features, errorSummary, submit, submitDelete }
    }
}
...
const ManageUserApiKeys = {
    ...
    setup(props) {
        ...
        const server = inject('server')
        const columns = "name,visibleKey,createdDate,expiryDate".split(',')
