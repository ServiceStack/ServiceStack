...
export const Logging = {
      ...
      <section v-if="!plugin">
          <div class="p-4 max-w-3xl">
            ...
            <div class="my-4">
              <div>
                <p>
                    The <b>RequestLogsFeature</b> plugin needs to be configured with your App
                          ...
                          <div v-if="selected.requestDto" class="flex overflow-auto">
                            ...
                            <span class="relative z-0 inline-flex shadow-sm rounded-md">
                              ...
                              <div v-if="routes.body === ''" class="pt-2 icon-outer" style="min-height:2.5rem">
                                ...
                                <pre class="whitespace-pre-wrap"><code :key="renderKey" lang="json"
    ...
    setup() {
        ...
        const useAutoQuery = computed(() => plugin?.analytics)
        ...
        const results = computed(() => grid.value?.results || api.value.response?.results || [])
        ...
        function handleKeyDown(e) {
            keydown(e, { canPrev, canNext, nextSkip, take, results, selected, clearFilters, show:'edit' })
        }
