...
<div class="relative inline-block text-left">
    ...
    <div v-if="openMenu" class="absolute right-0 mt-2 w-52 z-40 rounded-lg shadow-lg py-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-xs">
    ...
    <!-- Sign In Modal -->
    <Teleport to="body">
        <ModalDialog v-if="openSignIn" @done="openSignIn = false" size-class="sm:max-w-lg sm:w-full">
            <div class="p-4 bg-white dark:bg-gray-900 rounded-lg">
                <SignIn @login="signIn" @done="openSignIn = false" />
            </div>
        </ModalDialog>
    </Teleport>
</div>
...
export const AvatarButton = {
    ...
    setup() {
        ...
        function signIn() {
            ...
            // refresh the page after login to ensure the user is authenticated and the UI updates accordingly
            location.reload()
        }
