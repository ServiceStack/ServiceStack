...
class RequestLog implements IConvertible
{
    ...
    RequestLog({this.id=0,this.traceId,this.operationName,this.dateTime,this.statusCode=0,this.statusDescription,this.httpMethod,this.absoluteUri,this.pathInfo,this.request,this.requestBody,this.userAuthId,this.sessionId,this.ipAddress,this.forwardedFor,this.referer,this.headers=const {},this.formData,this.items=const {},this.responseHeaders,this.response,this.responseBody,this.sessionBody,this.error,this.exceptionSource,this.exceptionDataBody,this.requestDuration,this.meta});
    ...
    fromMap(Map<String, dynamic> json) {
        ...
        dateTime = JsonConverters.fromJson(json['dateTime'],'DateTime',context!) ?? DateTime(0);
...
class RedisEndpointInfo implements IConvertible
{
    ...
    RedisEndpointInfo({this.host,this.port=0,this.ssl,this.db=0,this.username,this.password});
...
abstract class BackgroundJobBase
{
    ...
    int? dependsOn;
    // @StringLength(100)
    String? dependsOnBatch;

    // @StringLength(200)
    String? concurrencyKey;

    JobDependencyPolicy? dependsOnPolicy;
    // @StringLength(100)
    String? tenantId;
    ...
    BackgroundJobBase({this.id=0,this.parentId,this.refId,this.worker,this.queue="",this.priority=0,this.tag,this.batchId,this.callback,this.dependsOn,this.dependsOnBatch,this.concurrencyKey,this.dependsOnPolicy,this.tenantId,this.traceId,this.runAfter,this.createdDate,this.createdBy,this.requestId,this.requestType="",this.command,this.request="",this.requestBody="",this.userId,this.response,this.responseBody,this.state,this.startedDate,this.completedDate,this.notifiedDate,this.retryLimit,this.retryBackoff,this.retryDelayMs,this.maxRetryDelayMs,this.attempts=0,this.durationMs=0,this.timeoutSecs,this.progress,this.status,this.logs,this.logsTruncated,this.lastActivityDate,this.cancelRequestedDate,this.expiresAt,this.leaseOwner,this.replyTo,this.errorCode,this.error,this.args,this.meta});
    ...
    fromMap(Map<String, dynamic> json) {
        ...
        dependsOnBatch = json['dependsOnBatch'];
        concurrencyKey = json['concurrencyKey'];
        dependsOnPolicy = JsonConverters.fromJson(json['dependsOnPolicy'],'JobDependencyPolicy',context!);
        ...
        retryBackoff = JsonConverters.fromJson(json['retryBackoff'],'RetryBackoff',context!);
        retryDelayMs = json['retryDelayMs'];
        maxRetryDelayMs = json['maxRetryDelayMs'];
    ...
    Map<String, dynamic> toJson() => {
        ...
        'callback': callback,
        'dependsOn': dependsOn,
        'dependsOnBatch': dependsOnBatch,
        'concurrencyKey': concurrencyKey,
        'dependsOnPolicy': JsonConverters.toJson(dependsOnPolicy,'JobDependencyPolicy',context!),
        'tenantId': tenantId,
        'traceId': traceId,
        ...
        'retryBackoff': JsonConverters.toJson(retryBackoff,'RetryBackoff',context!),
        ...
        'cancelRequestedDate': JsonConverters.toJson(cancelRequestedDate,'DateTime',context!),
...
class BackgroundJob extends BackgroundJobBase implements IConvertible
{
    ...
    BackgroundJob({this.id=0,this.singletonKey,this.leaseToken,this.leaseExpiresAt});
    BackgroundJob.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        super.fromMap(json);
        id = json['id'] ?? 0;
        singletonKey = json['singletonKey'];
        leaseToken = json['leaseToken'];
        leaseExpiresAt = JsonConverters.fromJson(json['leaseExpiresAt'],'DateTime',context!);
        return this;
    }
    ...
    Map<String, dynamic> toJson() => super.toJson()..addAll({
        ...
        'leaseExpiresAt': JsonConverters.toJson(leaseExpiresAt,'DateTime',context!)
    });
...
class JobSummary implements IConvertible
{
    ...
    JobSummary({this.id=0,this.parentId,this.refId,this.worker,this.queue="",this.priority=0,this.tag,this.batchId,this.createdDate,this.createdBy,this.requestType="",this.command,this.request="",this.response,this.userId,this.callback,this.startedDate,this.completedDate,this.state,this.durationMs=0,this.attempts=0,this.runAfter,this.cancelRequestedDate,this.expiresAt,this.concurrencyKey,this.singletonKey,this.tenantId,this.traceId,this.leaseOwner,this.logsTruncated,this.errorCode,this.errorMessage,this.meta});
...
{
    String? refId;
    DuplicateRefIdBehavior? duplicateRefIdBehavior;
    String? singletonKey;
    int? parentId;
    String? worker;
    String? queue;
    ...
    BackgroundJobOptions({this.refId,this.duplicateRefIdBehavior,this.singletonKey,this.parentId,this.worker,this.queue,this.priority,this.runAfter,this.expiresAt,this.expiresIn,this.callback,this.dependsOn,this.dependsOnBatch,this.dependsOnPolicy,this.concurrencyKey,this.tenantId,this.userId,this.retryLimit,this.retryBackoff,this.retryDelayMs,this.maxRetryDelayMs,this.retryDelay,this.maxRetryDelay,this.replyTo,this.tag,this.batchId,this.createdBy,this.timeoutSecs,this.timeout,this.args,this.runCommand});
    BackgroundJobOptions.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        refId = json['refId'];
        duplicateRefIdBehavior = JsonConverters.fromJson(json['duplicateRefIdBehavior'],'DuplicateRefIdBehavior',context!);
        singletonKey = json['singletonKey'];
        parentId = json['parentId'];
        worker = json['worker'];
        queue = json['queue'];
        ...
        runAfter = JsonConverters.fromJson(json['runAfter'],'DateTime',context!);
        expiresAt = JsonConverters.fromJson(json['expiresAt'],'DateTime',context!);
        expiresIn = JsonConverters.fromJson(json['expiresIn'],'Duration',context!);
        callback = json['callback'];
        dependsOn = json['dependsOn'];
        dependsOnBatch = json['dependsOnBatch'];
        dependsOnPolicy = JsonConverters.fromJson(json['dependsOnPolicy'],'JobDependencyPolicy',context!);
        ...
        retryDelayMs = json['retryDelayMs'];
        maxRetryDelayMs = json['maxRetryDelayMs'];
        retryDelay = JsonConverters.fromJson(json['retryDelay'],'Duration',context!);
        maxRetryDelay = JsonConverters.fromJson(json['maxRetryDelay'],'Duration',context!);
        replyTo = json['replyTo'];
        tag = json['tag'];
        batchId = json['batchId'];
        createdBy = json['createdBy'];
    ...
    Map<String, dynamic> toJson() => {
        'refId': refId,
        'duplicateRefIdBehavior': JsonConverters.toJson(duplicateRefIdBehavior,'DuplicateRefIdBehavior',context!),
        'singletonKey': singletonKey,
        'parentId': parentId,
        'worker': worker,
        'queue': queue,
        ...
        'runAfter': JsonConverters.toJson(runAfter,'DateTime',context!),
        'expiresAt': JsonConverters.toJson(expiresAt,'DateTime',context!),
        'expiresIn': JsonConverters.toJson(expiresIn,'Duration',context!),
        'callback': callback,
        'dependsOn': dependsOn,
        'dependsOnBatch': dependsOnBatch,
        'dependsOnPolicy': JsonConverters.toJson(dependsOnPolicy,'JobDependencyPolicy',context!),
        ...
        'retryDelayMs': retryDelayMs,
        'maxRetryDelayMs': maxRetryDelayMs,
        'retryDelay': JsonConverters.toJson(retryDelay,'Duration',context!),
        'maxRetryDelay': JsonConverters.toJson(maxRetryDelay,'Duration',context!),
        'replyTo': replyTo,
        'tag': tag,
        'batchId': batchId,
        'createdBy': createdBy,
...
class ScheduledTask implements IConvertible
{
    ...
    DateTime? lastRun;
    int? lastJobId;
    BackgroundJobState? lastRunState;
    int? lastRunDurationMs;
    DateTime? createdDate;
    DateTime? modifiedDate;
    Map<String,String?>? meta;

    ScheduledTask({this.id=0,this.name,this.interval,this.cronExpression,this.requestType,this.command,this.request,this.requestBody,this.options,this.enabled,this.startDate,this.endDate,this.maxRuns,this.runCount=0,this.nextRun,this.timeZoneId,this.misfirePolicy,this.overlapPolicy,this.lastErrorCode,this.lastErrorMessage,this.lastRun,this.lastJobId,this.lastRunState,this.lastRunDurationMs,this.createdDate,this.modifiedDate,this.meta});
    ...
    fromMap(Map<String, dynamic> json) {
        ...
        maxRuns = json['maxRuns'];
        runCount = json['runCount'] ?? 0;
        nextRun = JsonConverters.fromJson(json['nextRun'],'DateTime',context!);
        timeZoneId = json['timeZoneId'];
        misfirePolicy = JsonConverters.fromJson(json['misfirePolicy'],'ScheduleMisfirePolicy',context!);
        overlapPolicy = JsonConverters.fromJson(json['overlapPolicy'],'ScheduleOverlapPolicy',context!);
        ...
        lastRunState = JsonConverters.fromJson(json['lastRunState'],'BackgroundJobState',context!);
        lastRunDurationMs = json['lastRunDurationMs'];
    ...
    Map<String, dynamic> toJson() => {
        ...
        'maxRuns': maxRuns,
        'runCount': runCount,
        'nextRun': JsonConverters.toJson(nextRun,'DateTime',context!),
        'timeZoneId': timeZoneId,
        'misfirePolicy': JsonConverters.toJson(misfirePolicy,'ScheduleMisfirePolicy',context!),
        'overlapPolicy': JsonConverters.toJson(overlapPolicy,'ScheduleOverlapPolicy',context!),
        'lastErrorCode': lastErrorCode,
        'lastErrorMessage': lastErrorMessage,
        'lastRun': JsonConverters.toJson(lastRun,'DateTime',context!),
        'lastJobId': lastJobId,
        'lastRunState': JsonConverters.toJson(lastRunState,'BackgroundJobState',context!),
...
class ValidationRule extends ValidateRule implements IConvertible
{
    ...
    ValidationRule({this.id=0,this.type="",this.field,this.createdBy,this.createdDate,this.modifiedBy,this.modifiedDate,this.suspendedBy,this.suspendedDate,this.notes});
...
class LocodeUi implements IConvertible
{
    ...
    int maxNestedFields = 0;
    int maxNestedFieldLength = 0;

    LocodeUi({this.css,this.tags,this.maxFieldLength=0,this.maxNestedFields=0,this.maxNestedFieldLength=0});
    ...
    fromMap(Map<String, dynamic> json) {
        ...
        maxFieldLength = json['maxFieldLength'] ?? 0;
        maxNestedFields = json['maxNestedFields'] ?? 0;
        maxNestedFieldLength = json['maxNestedFieldLength'] ?? 0;
        return this;
    }
...
class RequestLogsInfo implements IConvertible
{
    ...
    RequestLogsInfo({this.accessRole,this.requestLogger,this.defaultLimit=0,this.serviceRoutes,this.analytics,this.meta});
    RequestLogsInfo.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        accessRole = json['accessRole'];
        requestLogger = json['requestLogger'];
        defaultLimit = json['defaultLimit'] ?? 0;
        serviceRoutes = JsonConverters.fromJson(json['serviceRoutes'],'Map<String,List<String>?>',context!);
...
class ProfilingInfo implements IConvertible
{
    ...
    ProfilingInfo({this.accessRole,this.defaultLimit=0,this.summaryFields,this.tagLabel,this.meta});
...
class AdminRedisInfo implements IConvertible
{
    ...
    AdminRedisInfo({this.queryLimit=0,this.databases,this.modifiableConnection,this.endpoint,this.meta});
    AdminRedisInfo.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        queryLimit = json['queryLimit'] ?? 0;
...
class AdminDatabaseInfo implements IConvertible
{
    ...
    AdminDatabaseInfo({this.queryLimit=0,this.databases,this.meta});
...
class PartialApiKey implements IConvertible
{
    ...
    PartialApiKey({this.id=0,this.name,this.userId,this.userName,this.visibleKey,this.environment,this.createdDate,this.expiryDate,this.cancelledDate,this.lastUsedDate,this.scopes,this.features,this.restrictTo,this.notes,this.refId,this.refIdStr,this.meta,this.active});
...
class DiagnosticEntry implements IConvertible
{
    ...
    DiagnosticEntry({this.id=0,this.traceId,this.source="",this.eventType="",this.message="",this.operation="",this.threadId=0,this.error,this.commandType="",this.command="",this.userAuthId,this.sessionId,this.arg,this.args,this.argLengths,this.namedArgs,this.duration,this.timestamp=0,this.date,this.tag,this.stackTrace,this.meta=const {}});
...
class RedisSearchResult implements IConvertible
{
    ...
    RedisSearchResult({this.id="",this.type="",this.ttl=0,this.size=0});
...
class CommandSummary implements IConvertible
{
    ...
    CommandSummary({this.type="",this.name="",this.count=0,this.failed=0,this.retries=0,this.totalMs=0,this.minMs=0,this.maxMs=0,this.averageMs=0,this.medianMs=0,this.lastError,this.timings});
    ...
    fromMap(Map<String, dynamic> json) {
        ...
        minMs = json['minMs'] ?? 0;
        maxMs = json['maxMs'] ?? 0;
        averageMs = JsonConverters.toDouble(json['averageMs']) ?? 0;
        medianMs = JsonConverters.toDouble(json['medianMs']) ?? 0;
...
class CommandResult implements IConvertible
{
    ...
    CommandResult({this.type="",this.name="",this.ms,this.at,this.request="",this.retries,this.attempt=0,this.error});
    ...
    fromMap(Map<String, dynamic> json) {
        ...
        name = json['name'] ?? "";
        ms = json['ms'];
        at = JsonConverters.fromJson(json['at'],'DateTime',context!) ?? DateTime(0);
        request = json['request'] ?? "";
...
class JobStatSummary implements IConvertible
{
    ...
    JobStatSummary({this.name="",this.total=0,this.completed=0,this.retries=0,this.failed=0,this.cancelled=0});
...
class HourSummary implements IConvertible
{
    ...
    HourSummary({this.hour="",this.total=0,this.completed=0,this.failed=0,this.cancelled=0});
...
class JobWaitTimes implements IConvertible
{
    int count = 0;
    int avgMs = 0;
    int maxMs = 0;
    ...
    JobWaitTimes({this.count=0,this.avgMs=0,this.maxMs=0,this.waitingMs});
    JobWaitTimes.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        count = json['count'] ?? 0;
        avgMs = json['avgMs'] ?? 0;
        maxMs = json['maxMs'] ?? 0;
        waitingMs = json['waitingMs'];
        return this;
    }
...
class WorkerStats implements IConvertible
{
    ...
    WorkerStats({this.name="",this.queued=0,this.received=0,this.completed=0,this.retries=0,this.failed=0,this.runningJob,this.runningTime});
...
class RequestLogEntry implements IConvertible
{
    ...
    RequestLogEntry({this.id=0,this.traceId,this.operationName,this.dateTime,this.statusCode=0,this.statusDescription,this.httpMethod,this.absoluteUri,this.pathInfo,this.requestBody,this.requestDto,this.userAuthId,this.sessionId,this.ipAddress,this.forwardedFor,this.referer,this.headers,this.formData,this.items,this.responseHeaders,this.session,this.responseDto,this.errorResponse,this.exceptionSource,this.exceptionData,this.requestDuration,this.meta});
...
class AnalyticsLogInfo implements IConvertible
{
    ...
    AnalyticsLogInfo({this.id=0,this.dateTime,this.browser,this.device,this.bot,this.op,this.userId,this.userName,this.apiKey,this.ip});
...
class RequestSummary implements IConvertible
{
    ...
    RequestSummary({this.name,this.totalRequests=0,this.totalRequestLength=0,this.minRequestLength=0,this.maxRequestLength=0,this.totalDuration=0,this.minDuration=0,this.maxDuration=0,this.status,this.durations,this.apis,this.users,this.ips,this.apiKeys});
    RequestSummary.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        name = json['name'];
        totalRequests = json['totalRequests'] ?? 0;
        totalRequestLength = json['totalRequestLength'] ?? 0;
        minRequestLength = json['minRequestLength'] ?? 0;
        maxRequestLength = json['maxRequestLength'] ?? 0;
        totalDuration = JsonConverters.toDouble(json['totalDuration']) ?? 0;
        minDuration = JsonConverters.toDouble(json['minDuration']) ?? 0;
        maxDuration = JsonConverters.toDouble(json['maxDuration']) ?? 0;
...
class AnalyticsReports implements IConvertible
{
    ...
    AnalyticsReports({this.id=0,this.created,this.version=0,this.apis,this.users,this.tags,this.status,this.days,this.apiKeys,this.ips,this.browsers,this.devices,this.bots,this.durations});
    AnalyticsReports.fromJson(Map<String, dynamic> json) { fromMap(json); }

    fromMap(Map<String, dynamic> json) {
        id = json['id'] ?? 0;
        created = JsonConverters.fromJson(json['created'],'DateTime',context!) ?? DateTime(0);
        version = JsonConverters.toDouble(json['version']) ?? 0;
...
class AdminProfilingResponse implements IConvertible
{
    ...
    AdminProfilingResponse({this.results=const [],this.total=0,this.responseStatus});
...
class AdminRedisResponse implements IConvertible
{
    ...
    AdminRedisResponse({this.db=0,this.searchResults,this.info,this.endpoint,this.result,this.responseStatus});
...
class AdminDatabaseResponse implements IConvertible
{
    ...
    AdminDatabaseResponse({this.results=const [],this.total,this.columns,this.responseStatus});
...
class ViewCommandsResponse implements IConvertible
{
    ...
    ViewCommandsResponse({this.commandTotals=const [],this.latestCommands=const [],this.latestFailed=const [],this.responseStatus});
...
class AdminJobDashboardResponse implements IConvertible
{
    ...
    List<JobStatSummary> queues = [];
    List<HourSummary> today = [];
    JobWaitTimes? waitTimes;
    ResponseStatus? responseStatus;

    AdminJobDashboardResponse({this.commands=const [],this.apis=const [],this.workers=const [],this.queues=const [],this.today=const [],this.waitTimes,this.responseStatus});
    ...
    fromMap(Map<String, dynamic> json) {
        ...
        queues = JsonConverters.fromJson(json['queues'],'List<JobStatSummary>',context!) ?? [];
        today = JsonConverters.fromJson(json['today'],'List<HourSummary>',context!) ?? [];
        waitTimes = JsonConverters.fromJson(json['waitTimes'],'JobWaitTimes',context!);
        responseStatus = JsonConverters.fromJson(json['responseStatus'],'ResponseStatus',context!);
        return this;
    }
    ...
    Map<String, dynamic> toJson() => {
        ...
        'queues': JsonConverters.toJson(queues,'List<JobStatSummary>',context!),
        'today': JsonConverters.toJson(today,'List<HourSummary>',context!),
        'waitTimes': JsonConverters.toJson(waitTimes,'JobWaitTimes',context!),
        'responseStatus': JsonConverters.toJson(responseStatus,'ResponseStatus',context!)
    };
...
class AdminJobInfoResponse implements IConvertible
{
    ...
    AdminJobInfoResponse({this.provider,this.capabilities,this.monthDbs,this.tableCounts,this.workerStats,this.queueCounts,this.workerCounts,this.stateCounts,this.responseStatus});
...
class AdminGetJobProgressResponse implements IConvertible
{
    ...
    AdminGetJobProgressResponse({this.state,this.progress,this.status,this.logs,this.logsTruncated,this.durationMs,this.error,this.responseStatus});
...
class AdminRequeueFailedJobsJobsResponse implements IConvertible
{
    ...
    AdminRequeueFailedJobsJobsResponse({this.results=const [],this.errors=const {},this.responseStatus});
...
class AdminCancelJobsResponse implements IConvertible
{
    ...
    AdminCancelJobsResponse({this.results=const [],this.errors=const {},this.responseStatus});
...
class RequestLogsResponse implements IConvertible
{
    ...
    RequestLogsResponse({this.results,this.usage,this.total=0,this.responseStatus});
...
class AdminUpdateApiKey implements IReturn<EmptyResponse>, IPatch, IConvertible
{
    ...
    AdminUpdateApiKey({this.id=0,this.name,this.userId,this.userName,this.scopes,this.features,this.restrictTo,this.expiryDate,this.cancelledDate,this.notes,this.refId,this.refIdStr,this.meta,this.reset});
...
class AdminProfiling implements IReturn<AdminProfilingResponse>, IConvertible, IPost
{
    ...
    AdminProfiling({this.source,this.eventType,this.threadId,this.traceId,this.userAuthId,this.sessionId,this.tag,this.skip=0,this.take,this.orderBy,this.withErrors,this.pending});
...
class AdminGetJobProgress implements IReturn<AdminGetJobProgressResponse>, IGet, IConvertible
{
    ...
    AdminGetJobProgress({this.id=0,this.logStart});
...
class AdminRequeueFailedJobs implements IReturn<AdminRequeueFailedJobsJobsResponse>, IConvertible, IPost
{
    ...
    AdminRequeueFailedJobs({this.ids,this.tag,this.batchId,this.from});
...
class AdminCancelJobs implements IReturn<AdminCancelJobsResponse>, IGet, IConvertible
{
    ...
    AdminCancelJobs({this.ids,this.worker,this.state,this.queue,this.tag,this.batchId,this.cancelWorker});
...
TypeContext _ctx = TypeContext(library: 'localhost', types: <String, TypeInfo> {
    ...
    'JobDependencyPolicy': TypeInfo(TypeOf.Enum, enumValues:JobDependencyPolicy.values),
    'BackgroundJobState': TypeInfo(TypeOf.Enum, enumValues:BackgroundJobState.values),
    'RetryBackoff': TypeInfo(TypeOf.Enum, enumValues:RetryBackoff.values),
    ...
    'DuplicateRefIdBehavior': TypeInfo(TypeOf.Enum, enumValues:DuplicateRefIdBehavior.values),
    'BackgroundJobOptions': TypeInfo(TypeOf.Class, create:() => BackgroundJobOptions()),
    'ScheduleMisfirePolicy': TypeInfo(TypeOf.Enum, enumValues:ScheduleMisfirePolicy.values),
    'ScheduleOverlapPolicy': TypeInfo(TypeOf.Enum, enumValues:ScheduleOverlapPolicy.values),
    ...
    'JobWaitTimes': TypeInfo(TypeOf.Class, create:() => JobWaitTimes()),
