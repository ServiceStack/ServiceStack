...
class JobDependencyPolicy(str, Enum):
...
class BackgroundJobBase:
    ...
    # @StringLength(100)
    depends_on_batch: Optional[str] = None

    # @StringLength(200)
    concurrency_key: Optional[str] = None

    depends_on_policy: Optional[JobDependencyPolicy] = None
    # @StringLength(100)
    ...
    cancel_requested_date: Optional[datetime.datetime] = None
...
class DuplicateRefIdBehavior(str, Enum):
    THROW = 'Throw'
...
class BackgroundJobOptions:
    ref_id: Optional[str] = None
    duplicate_ref_id_behavior: Optional[DuplicateRefIdBehavior] = None
    singleton_key: Optional[str] = None
    parent_id: Optional[int] = None
    worker: Optional[str] = None
    queue: Optional[str] = None
    ...
    max_retry_delay: Optional[datetime.timedelta] = None
    reply_to: Optional[str] = None
    tag: Optional[str] = None
    batch_id: Optional[str] = None
    created_by: Optional[str] = None
...
class ScheduledTask:
    ...
    misfire_policy: Optional[ScheduleMisfirePolicy] = None
    ...
    last_run_state: Optional[BackgroundJobState] = None
...
class AdminJobDashboardResponse:
    ...
    queues: List[JobStatSummary] = field(default_factory=list)
    today: List[HourSummary] = field(default_factory=list)
    wait_times: Optional[JobWaitTimes] = None
    response_status: Optional[ResponseStatus] = None
