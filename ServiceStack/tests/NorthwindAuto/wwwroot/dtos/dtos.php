...
enum JobDependencyPolicy : string
{
...
enum RetryBackoff : string
{
    ...
    case ExponentialJitter = 'ExponentialJitter';
}
...
class BackgroundJobBase implements JsonSerializable
{
    public function __construct(
        ...
        /** @var bool|null */
        public ?bool $logsTruncated=null,
        /** @var DateTime|null */
        public ?DateTime $lastActivityDate=null,
        /** @var DateTime|null */
        public ?DateTime $cancelRequestedDate=null,
        /** @var DateTime|null */
    ...
    public function fromMap($o): void {
        ...
        if (isset($o['dependsOnBatch'])) $this->dependsOnBatch = $o['dependsOnBatch'];
        if (isset($o['concurrencyKey'])) $this->concurrencyKey = $o['concurrencyKey'];
        if (isset($o['dependsOnPolicy'])) $this->dependsOnPolicy = JsonConverters::from('JobDependencyPolicy', $o['dependsOnPolicy']);
        ...
        if (isset($o['retryBackoff'])) $this->retryBackoff = JsonConverters::from('RetryBackoff', $o['retryBackoff']);
        if (isset($o['retryDelayMs'])) $this->retryDelayMs = $o['retryDelayMs'];
        if (isset($o['maxRetryDelayMs'])) $this->maxRetryDelayMs = $o['maxRetryDelayMs'];
        ...
        if (isset($o['logsTruncated'])) $this->logsTruncated = $o['logsTruncated'];
        if (isset($o['lastActivityDate'])) $this->lastActivityDate = JsonConverters::from('DateTime', $o['lastActivityDate']);
        if (isset($o['cancelRequestedDate'])) $this->cancelRequestedDate = JsonConverters::from('DateTime', $o['cancelRequestedDate']);
        if (isset($o['expiresAt'])) $this->expiresAt = JsonConverters::from('DateTime', $o['expiresAt']);
        if (isset($o['leaseOwner'])) $this->leaseOwner = $o['leaseOwner'];
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->dependsOnBatch)) $o['dependsOnBatch'] = $this->dependsOnBatch;
        if (isset($this->concurrencyKey)) $o['concurrencyKey'] = $this->concurrencyKey;
        if (isset($this->dependsOnPolicy)) $o['dependsOnPolicy'] = JsonConverters::to('JobDependencyPolicy', $this->dependsOnPolicy);
        ...
        if (isset($this->retryBackoff)) $o['retryBackoff'] = JsonConverters::to('RetryBackoff', $this->retryBackoff);
        if (isset($this->retryDelayMs)) $o['retryDelayMs'] = $this->retryDelayMs;
        if (isset($this->maxRetryDelayMs)) $o['maxRetryDelayMs'] = $this->maxRetryDelayMs;
        ...
        if (isset($this->logsTruncated)) $o['logsTruncated'] = $this->logsTruncated;
        if (isset($this->lastActivityDate)) $o['lastActivityDate'] = JsonConverters::to('DateTime', $this->lastActivityDate);
        if (isset($this->cancelRequestedDate)) $o['cancelRequestedDate'] = JsonConverters::to('DateTime', $this->cancelRequestedDate);
        if (isset($this->expiresAt)) $o['expiresAt'] = JsonConverters::to('DateTime', $this->expiresAt);
        if (isset($this->leaseOwner)) $o['leaseOwner'] = $this->leaseOwner;
...
class BackgroundJob extends BackgroundJobBase implements JsonSerializable
{
     ...
     * @param string|null $dependsOnBatch
     * @param string|null $concurrencyKey
     * @param JobDependencyPolicy|null $dependsOnPolicy
     ...
     * @param RetryBackoff|null $retryBackoff
     * @param int|null $retryDelayMs
     * @param int|null $maxRetryDelayMs
     * @param int $attempts
     ...
     * @param bool|null $logsTruncated
     * @param DateTime|null $lastActivityDate
     * @param DateTime|null $cancelRequestedDate
    ...
    public function __construct(
        ...
        ?int $dependsOn=null,
        ?string $dependsOnBatch=null,
        ?string $concurrencyKey=null,
        ?JobDependencyPolicy $dependsOnPolicy=null,
        ...
        ?string $status=null,
        ?string $logs=null,
        ?bool $logsTruncated=null,
        ?DateTime $lastActivityDate=null,
        ?DateTime $cancelRequestedDate=null,
        ...
        parent::__construct($id,$parentId,$refId,$worker,$queue,$priority,$tag,$batchId,$callback,$dependsOn,$dependsOnBatch,$concurrencyKey,$dependsOnPolicy,$tenantId,$traceId,$runAfter,$createdDate,$createdBy,$requestId,$requestType,$command,$request,$requestBody,$userId,$response,$responseBody,$state,$startedDate,$completedDate,$notifiedDate,$retryLimit,$retryBackoff,$retryDelayMs,$maxRetryDelayMs,$attempts,$durationMs,$timeoutSecs,$progress,$status,$logs,$logsTruncated,$lastActivityDate,$cancelRequestedDate,$expiresAt,$leaseOwner,$replyTo,$errorCode,$error,$args,$meta);
    }
    ...
    public function fromMap($o): void {
        parent::fromMap($o);
        if (isset($o['id'])) $this->id = $o['id'];
        if (isset($o['singletonKey'])) $this->singletonKey = $o['singletonKey'];
        if (isset($o['leaseToken'])) $this->leaseToken = $o['leaseToken'];
        if (isset($o['leaseExpiresAt'])) $this->leaseExpiresAt = JsonConverters::from('DateTime', $o['leaseExpiresAt']);
    }
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->id)) $o['id'] = $this->id;
        if (isset($this->singletonKey)) $o['singletonKey'] = $this->singletonKey;
        if (isset($this->leaseToken)) $o['leaseToken'] = $this->leaseToken;
        if (isset($this->leaseExpiresAt)) $o['leaseExpiresAt'] = JsonConverters::to('DateTime', $this->leaseExpiresAt);
        return empty($o) ? new class(){} : $o;
    }
}
...
enum DuplicateRefIdBehavior : string
{
    case Throw = 'Throw';
    case ReturnExisting = 'ReturnExisting';
}
...
class BackgroundJobOptions implements JsonSerializable
{
    public function __construct(
        /** @var string|null */
        public ?string $refId=null,
        /** @var DuplicateRefIdBehavior|null */
        ...
        public ?DateTime $expiresAt=null,
        /** @var DateInterval|null */
        public ?DateInterval $expiresIn=null,
        /** @var string|null */
        public ?string $callback=null,
        /** @var int|null */
        public ?int $dependsOn=null,
        ...
        /** @var DateInterval|null */
        public ?DateInterval $maxRetryDelay=null,
        /** @var string|null */
        public ?string $replyTo=null,
        /** @var string|null */
        public ?string $tag=null,
    ...
    public function fromMap($o): void {
        if (isset($o['refId'])) $this->refId = $o['refId'];
        if (isset($o['duplicateRefIdBehavior'])) $this->duplicateRefIdBehavior = JsonConverters::from('DuplicateRefIdBehavior', $o['duplicateRefIdBehavior']);
        if (isset($o['singletonKey'])) $this->singletonKey = $o['singletonKey'];
        if (isset($o['parentId'])) $this->parentId = $o['parentId'];
        if (isset($o['worker'])) $this->worker = $o['worker'];
        if (isset($o['queue'])) $this->queue = $o['queue'];
        ...
        if (isset($o['runAfter'])) $this->runAfter = JsonConverters::from('DateTime', $o['runAfter']);
        if (isset($o['expiresAt'])) $this->expiresAt = JsonConverters::from('DateTime', $o['expiresAt']);
        if (isset($o['expiresIn'])) $this->expiresIn = JsonConverters::from('TimeSpan', $o['expiresIn']);
        if (isset($o['callback'])) $this->callback = $o['callback'];
        if (isset($o['dependsOn'])) $this->dependsOn = $o['dependsOn'];
        if (isset($o['dependsOnBatch'])) $this->dependsOnBatch = $o['dependsOnBatch'];
        if (isset($o['dependsOnPolicy'])) $this->dependsOnPolicy = JsonConverters::from('JobDependencyPolicy', $o['dependsOnPolicy']);
        ...
        if (isset($o['retryDelayMs'])) $this->retryDelayMs = $o['retryDelayMs'];
        if (isset($o['maxRetryDelayMs'])) $this->maxRetryDelayMs = $o['maxRetryDelayMs'];
        if (isset($o['retryDelay'])) $this->retryDelay = JsonConverters::from('TimeSpan', $o['retryDelay']);
        if (isset($o['maxRetryDelay'])) $this->maxRetryDelay = JsonConverters::from('TimeSpan', $o['maxRetryDelay']);
        if (isset($o['replyTo'])) $this->replyTo = $o['replyTo'];
        if (isset($o['tag'])) $this->tag = $o['tag'];
        if (isset($o['batchId'])) $this->batchId = $o['batchId'];
        if (isset($o['createdBy'])) $this->createdBy = $o['createdBy'];
    ...
    public function jsonSerialize(): mixed
    {
        $o = [];
        if (isset($this->refId)) $o['refId'] = $this->refId;
        if (isset($this->duplicateRefIdBehavior)) $o['duplicateRefIdBehavior'] = JsonConverters::to('DuplicateRefIdBehavior', $this->duplicateRefIdBehavior);
        if (isset($this->singletonKey)) $o['singletonKey'] = $this->singletonKey;
        if (isset($this->parentId)) $o['parentId'] = $this->parentId;
        if (isset($this->worker)) $o['worker'] = $this->worker;
        if (isset($this->queue)) $o['queue'] = $this->queue;
        ...
        if (isset($this->runAfter)) $o['runAfter'] = JsonConverters::to('DateTime', $this->runAfter);
        if (isset($this->expiresAt)) $o['expiresAt'] = JsonConverters::to('DateTime', $this->expiresAt);
        if (isset($this->expiresIn)) $o['expiresIn'] = JsonConverters::to('TimeSpan', $this->expiresIn);
        if (isset($this->callback)) $o['callback'] = $this->callback;
        if (isset($this->dependsOn)) $o['dependsOn'] = $this->dependsOn;
        if (isset($this->dependsOnBatch)) $o['dependsOnBatch'] = $this->dependsOnBatch;
        if (isset($this->dependsOnPolicy)) $o['dependsOnPolicy'] = JsonConverters::to('JobDependencyPolicy', $this->dependsOnPolicy);
        ...
        if (isset($this->retryDelayMs)) $o['retryDelayMs'] = $this->retryDelayMs;
        if (isset($this->maxRetryDelayMs)) $o['maxRetryDelayMs'] = $this->maxRetryDelayMs;
        if (isset($this->retryDelay)) $o['retryDelay'] = JsonConverters::to('TimeSpan', $this->retryDelay);
        if (isset($this->maxRetryDelay)) $o['maxRetryDelay'] = JsonConverters::to('TimeSpan', $this->maxRetryDelay);
        if (isset($this->replyTo)) $o['replyTo'] = $this->replyTo;
        if (isset($this->tag)) $o['tag'] = $this->tag;
        if (isset($this->batchId)) $o['batchId'] = $this->batchId;
        if (isset($this->createdBy)) $o['createdBy'] = $this->createdBy;
...
enum ScheduleMisfirePolicy : string
{
...
class ScheduledTask implements JsonSerializable
{
    public function __construct(
        ...
        /** @var ScheduleMisfirePolicy|null */
        public ?ScheduleMisfirePolicy $misfirePolicy=null,
        /** @var ScheduleOverlapPolicy|null */
    ...
    public function fromMap($o): void {
        ...
        if (isset($o['maxRuns'])) $this->maxRuns = $o['maxRuns'];
        if (isset($o['runCount'])) $this->runCount = $o['runCount'];
        if (isset($o['nextRun'])) $this->nextRun = JsonConverters::from('DateTime', $o['nextRun']);
        if (isset($o['timeZoneId'])) $this->timeZoneId = $o['timeZoneId'];
        if (isset($o['misfirePolicy'])) $this->misfirePolicy = JsonConverters::from('ScheduleMisfirePolicy', $o['misfirePolicy']);
        if (isset($o['overlapPolicy'])) $this->overlapPolicy = JsonConverters::from('ScheduleOverlapPolicy', $o['overlapPolicy']);
        if (isset($o['lastErrorCode'])) $this->lastErrorCode = $o['lastErrorCode'];
        if (isset($o['lastErrorMessage'])) $this->lastErrorMessage = $o['lastErrorMessage'];
        if (isset($o['lastRun'])) $this->lastRun = JsonConverters::from('DateTime', $o['lastRun']);
        if (isset($o['lastJobId'])) $this->lastJobId = $o['lastJobId'];
        if (isset($o['lastRunState'])) $this->lastRunState = JsonConverters::from('BackgroundJobState', $o['lastRunState']);
        if (isset($o['lastRunDurationMs'])) $this->lastRunDurationMs = $o['lastRunDurationMs'];
        if (isset($o['createdDate'])) $this->createdDate = JsonConverters::from('DateTime', $o['createdDate']);
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->maxRuns)) $o['maxRuns'] = $this->maxRuns;
        if (isset($this->runCount)) $o['runCount'] = $this->runCount;
        if (isset($this->nextRun)) $o['nextRun'] = JsonConverters::to('DateTime', $this->nextRun);
        if (isset($this->timeZoneId)) $o['timeZoneId'] = $this->timeZoneId;
        if (isset($this->misfirePolicy)) $o['misfirePolicy'] = JsonConverters::to('ScheduleMisfirePolicy', $this->misfirePolicy);
        if (isset($this->overlapPolicy)) $o['overlapPolicy'] = JsonConverters::to('ScheduleOverlapPolicy', $this->overlapPolicy);
        if (isset($this->lastErrorCode)) $o['lastErrorCode'] = $this->lastErrorCode;
        if (isset($this->lastErrorMessage)) $o['lastErrorMessage'] = $this->lastErrorMessage;
        ...
        if (isset($this->lastRunState)) $o['lastRunState'] = JsonConverters::to('BackgroundJobState', $this->lastRunState);
        if (isset($this->lastRunDurationMs)) $o['lastRunDurationMs'] = $this->lastRunDurationMs;
        if (isset($this->createdDate)) $o['createdDate'] = JsonConverters::to('DateTime', $this->createdDate);
...
class ExplorerUi implements JsonSerializable
{
    ...
    public function fromMap($o): void {
        if (isset($o['css'])) $this->css = JsonConverters::from('ApiCss', $o['css']);
        if (isset($o['tags'])) $this->tags = JsonConverters::from('AppTags', $o['tags']);
        if (isset($o['jsConfig'])) $this->jsConfig = $o['jsConfig'];
    }
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->css)) $o['css'] = JsonConverters::to('ApiCss', $this->css);
        if (isset($this->tags)) $o['tags'] = JsonConverters::to('AppTags', $this->tags);
        if (isset($this->jsConfig)) $o['jsConfig'] = $this->jsConfig;
        return empty($o) ? new class(){} : $o;
    }
}
...
class PageInfo implements JsonSerializable
{
    ...
    public function fromMap($o): void {
        ...
        if (isset($o['component'])) $this->component = $o['component'];
    }
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->component)) $o['component'] = $this->component;
        return empty($o) ? new class(){} : $o;
    }
}
...
class AdminUi implements JsonSerializable
{
    ...
    public function fromMap($o): void {
        if (isset($o['css'])) $this->css = JsonConverters::from('ApiCss', $o['css']);
        if (isset($o['pages'])) $this->pages = JsonConverters::fromArray('PageInfo', $o['pages']);
    }
    ...
    public function jsonSerialize(): mixed
    {
        $o = [];
        if (isset($this->css)) $o['css'] = JsonConverters::to('ApiCss', $this->css);
        if (isset($this->pages)) $o['pages'] = JsonConverters::toArray('PageInfo', $this->pages);
        return empty($o) ? new class(){} : $o;
    }
}
...
class UiInfo implements JsonSerializable
{
    public function __construct(
        ...
        /** @var array<string>|null */
        public ?array $adminLinksOrder=null,
        /** @var ThemeInfo|null */
    ...
    public function fromMap($o): void {
        ...
        if (isset($o['userIcon'])) $this->userIcon = JsonConverters::from('ImageInfo', $o['userIcon']);
        ...
        if (isset($o['adminLinksOrder'])) $this->adminLinksOrder = JsonConverters::fromArray('string', $o['adminLinksOrder']);
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->userIcon)) $o['userIcon'] = JsonConverters::to('ImageInfo', $this->userIcon);
        ...
        if (isset($this->adminLinksOrder)) $o['adminLinksOrder'] = JsonConverters::toArray('string', $this->adminLinksOrder);
...
class RequestLogsAnalytics implements JsonSerializable
{
    public function __construct(
        /** @var array<string>|null */
        ...
        /** @var bool|null */
        public ?bool $disableAnalytics=null,
        /** @var bool|null */
        public ?bool $disableUserAnalytics=null,
        /** @var bool|null */
        public ?bool $disableApiKeyAnalytics=null
    ) {
    }
    ...
    public function fromMap($o): void {
        ...
        if (isset($o['tabs'])) $this->tabs = JsonConverters::from(JsonConverters::context('Dictionary',genericArgs:['string','string']), $o['tabs']);
        if (isset($o['disableAnalytics'])) $this->disableAnalytics = $o['disableAnalytics'];
        if (isset($o['disableUserAnalytics'])) $this->disableUserAnalytics = $o['disableUserAnalytics'];
        if (isset($o['disableApiKeyAnalytics'])) $this->disableApiKeyAnalytics = $o['disableApiKeyAnalytics'];
    }
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->tabs)) $o['tabs'] = JsonConverters::to(JsonConverters::context('Dictionary',genericArgs:['string','string']), $this->tabs);
        if (isset($this->disableAnalytics)) $o['disableAnalytics'] = $this->disableAnalytics;
        if (isset($this->disableUserAnalytics)) $o['disableUserAnalytics'] = $this->disableUserAnalytics;
        if (isset($this->disableApiKeyAnalytics)) $o['disableApiKeyAnalytics'] = $this->disableApiKeyAnalytics;
        return empty($o) ? new class(){} : $o;
    }
}
...
class RequestLogsInfo implements JsonSerializable
{
    ...
    public function fromMap($o): void {
        ...
        if (isset($o['serviceRoutes'])) $this->serviceRoutes = JsonConverters::from(JsonConverters::context('Dictionary',genericArgs:['string','String[]']), $o['serviceRoutes']);
        if (isset($o['analytics'])) $this->analytics = JsonConverters::from('RequestLogsAnalytics', $o['analytics']);
        if (isset($o['meta'])) $this->meta = JsonConverters::from(JsonConverters::context('Dictionary',genericArgs:['string','string']), $o['meta']);
    }
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->serviceRoutes)) $o['serviceRoutes'] = JsonConverters::to(JsonConverters::context('Dictionary',genericArgs:['string','String[]']), $this->serviceRoutes);
        if (isset($this->analytics)) $o['analytics'] = JsonConverters::to('RequestLogsAnalytics', $this->analytics);
        if (isset($this->meta)) $o['meta'] = JsonConverters::to(JsonConverters::context('Dictionary',genericArgs:['string','string']), $this->meta);
        return empty($o) ? new class(){} : $o;
    }
}
...
class JobWaitTimes implements JsonSerializable
{
    public function __construct(
        /** @var int */
        public int $count=0,
    ...
    public function fromMap($o): void {
        if (isset($o['count'])) $this->count = $o['count'];
        if (isset($o['avgMs'])) $this->avgMs = $o['avgMs'];
        if (isset($o['maxMs'])) $this->maxMs = $o['maxMs'];
        if (isset($o['waitingMs'])) $this->waitingMs = $o['waitingMs'];
    }
    ...
    public function jsonSerialize(): mixed
    {
        $o = [];
        if (isset($this->count)) $o['count'] = $this->count;
        if (isset($this->avgMs)) $o['avgMs'] = $this->avgMs;
        if (isset($this->maxMs)) $o['maxMs'] = $this->maxMs;
        if (isset($this->waitingMs)) $o['waitingMs'] = $this->waitingMs;
        return empty($o) ? new class(){} : $o;
    }
}
...
class AdminJobDashboardResponse implements JsonSerializable
{
    ...
    public function fromMap($o): void {
        ...
        if (isset($o['queues'])) $this->queues = JsonConverters::fromArray('JobStatSummary', $o['queues']);
        if (isset($o['today'])) $this->today = JsonConverters::fromArray('HourSummary', $o['today']);
        if (isset($o['waitTimes'])) $this->waitTimes = JsonConverters::from('JobWaitTimes', $o['waitTimes']);
        if (isset($o['responseStatus'])) $this->responseStatus = JsonConverters::from('ResponseStatus', $o['responseStatus']);
    }
    ...
    public function jsonSerialize(): mixed
    {
        ...
        if (isset($this->queues)) $o['queues'] = JsonConverters::toArray('JobStatSummary', $this->queues);
        if (isset($this->today)) $o['today'] = JsonConverters::toArray('HourSummary', $this->today);
        if (isset($this->waitTimes)) $o['waitTimes'] = JsonConverters::to('JobWaitTimes', $this->waitTimes);
        if (isset($this->responseStatus)) $o['responseStatus'] = JsonConverters::to('ResponseStatus', $this->responseStatus);
        return empty($o) ? new class(){} : $o;
    }
}
