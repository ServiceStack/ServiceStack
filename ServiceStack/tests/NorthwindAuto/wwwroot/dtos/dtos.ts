...
export enum JobDependencyPolicy
{
    OnSuccess = 'OnSuccess',
...
export class BackgroundJobBase
{
    ...
    // @StringLength(100)
    public dependsOnBatch?: string;

    // @StringLength(200)
    public concurrencyKey?: string;

    public dependsOnPolicy?: JobDependencyPolicy;
    // @StringLength(100)
    ...
    public logsTruncated?: boolean;
    public lastActivityDate?: string;
    public cancelRequestedDate?: string;
...
export enum DuplicateRefIdBehavior
{
    Throw = 'Throw',
...
{
    public refId?: string;
    public duplicateRefIdBehavior: DuplicateRefIdBehavior;
    public singletonKey?: string;
    public parentId?: number;
    public worker?: string;
    public queue?: string;
...
export class ScheduledTask
{
    ...
    public misfirePolicy: ScheduleMisfirePolicy;
    public overlapPolicy: ScheduleOverlapPolicy;
    // @StringLength(100)
    ...
    public lastRunState?: BackgroundJobState;
...
export class JobWaitTimes
{
    ...
    public avgMs: number;
    public maxMs: number;
    public waitingMs?: number;

    public constructor(init?: Partial<JobWaitTimes>) { (Object as any).assign(this, init); }
}
...
export class AdminJobDashboardResponse
{
    ...
    public queues: JobStatSummary[] = [];
    public today: HourSummary[] = [];
    public waitTimes: JobWaitTimes;
    public responseStatus?: ResponseStatus;
