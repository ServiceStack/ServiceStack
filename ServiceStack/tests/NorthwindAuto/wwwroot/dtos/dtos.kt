...
open class QueryResponse<T>
{
    ...
    @DataMember(Order=3)
    open var results:ArrayList<RequestLog> = ArrayList<RequestLog>()
...
open class AdminJobDashboardResponse
{
    ...
    open var queues:ArrayList<JobStatSummary> = ArrayList<JobStatSummary>()
    open var today:ArrayList<HourSummary> = ArrayList<HourSummary>()
    open var waitTimes:JobWaitTimes? = null
    open var responseStatus:ResponseStatus? = null
}
...
{
    open var provider:String? = null
    open var capabilities:ArrayList<String>? = null
...
open class AdminGetJobProgressResponse
{
    ...
    open var logsTruncated:Boolean? = null
...
open class BackgroundJob : BackgroundJobBase()
{
    ...
    open var singletonKey:String? = null

    @StringLength(MaximumLength=32)
    open var leaseToken:String? = null

    open var leaseExpiresAt:Date? = null
}
...
open class JobSummary
{
    ...
    open var cancelRequestedDate:Date? = null
    open var expiresAt:Date? = null
    @StringLength(MaximumLength=200)
    open var concurrencyKey:String? = null
...
open class ScheduledTask
{
    ...
    open var maxRuns:Int? = null
    open var runCount:Int? = null
    open var nextRun:Date? = null
    @StringLength(MaximumLength=100)
    open var timeZoneId:String? = null

    open var misfirePolicy:ScheduleMisfirePolicy? = null
    open var overlapPolicy:ScheduleOverlapPolicy? = null
    @StringLength(MaximumLength=100)
    open var lastErrorCode:String? = null
    ...
    open var lastRunState:BackgroundJobState? = null
    open var lastRunDurationMs:Int? = null
    open var createdDate:Date? = null
...
open class JobWaitTimes
{
    open var count:Int? = null
    open var avgMs:Int? = null
    open var maxMs:Int? = null
    open var waitingMs:Int? = null
}
...
enum class JobDependencyPolicy
{
    OnSuccess,
    OnFinished,
}
...
open class BackgroundJobBase
{
    ...
    @StringLength(MaximumLength=100)
    open var dependsOnBatch:String? = null

    @StringLength(MaximumLength=200)
    open var concurrencyKey:String? = null

    open var dependsOnPolicy:JobDependencyPolicy? = null
    @StringLength(MaximumLength=100)
    open var tenantId:String? = null
    ...
    open var retryBackoff:RetryBackoff? = null
    open var retryDelayMs:Int? = null
    open var maxRetryDelayMs:Int? = null
    open var attempts:Int? = null
    open var durationMs:Int? = null
...
{
    open var refId:String? = null
    open var duplicateRefIdBehavior:DuplicateRefIdBehavior? = null
    open var singletonKey:String? = null
    open var parentId:Long? = null
    open var worker:String? = null
    open var queue:String? = null
    ...
    open var runAfter:Date? = null
    open var expiresAt:Date? = null
    open var expiresIn:TimeSpan? = null
    open var callback:String? = null
    open var dependsOn:Long? = null
    open var dependsOnBatch:String? = null
    open var dependsOnPolicy:JobDependencyPolicy? = null
    ...
    open var retryDelayMs:Int? = null
    open var maxRetryDelayMs:Int? = null
    open var retryDelay:TimeSpan? = null
    open var maxRetryDelay:TimeSpan? = null
    open var replyTo:String? = null
    open var tag:String? = null
    open var batchId:String? = null
    open var createdBy:String? = null
...
enum class ScheduleMisfirePolicy
{
    RunOnce,
    Skip,
}
...
enum class DuplicateRefIdBehavior
{
    Throw,
    ReturnExisting,
}
