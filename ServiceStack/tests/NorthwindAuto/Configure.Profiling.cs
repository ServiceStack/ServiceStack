...
public class GetDiagnosticEntries
{
}
public class GetDiagnosticEntriesResponse
{
...
{
    public async Task<object> Any(GetDiagnosticEntries request)
    {
        ...
        return new GetDiagnosticEntriesResponse
        {
            Results = logs.ToList(),
        };
    }
...
public class ProfilingFeature : IPlugin, ServiceStack.Model.IHasStringId
{
    ...
    {
        appHost.RegisterService(typeof(ProfilingService));
