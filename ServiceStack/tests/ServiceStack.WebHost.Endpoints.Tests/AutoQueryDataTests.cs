...
public class AutoQueryDataAppHost() : AppSelfHostBase("AutoQueryData", typeof(AutoQueryService).Assembly)
{
    ...
    public static AllFields[] SeedAllFields =
    [
        new AllFields
        {
            Id = 1,
...
public abstract class AutoQueryDataTests
{
    ...
    public List<Rockstar> Rockstars => AutoQueryDataAppHost.SeedRockstars.ToList();

    public List<PagingTest> PagingTests => AutoQueryDataAppHost.SeedPagingTest.ToList();

    public bool IsDynamoDb => appHost is AutoQueryDataDynamoAppHost;
