...
public class ChatResponse : Codable
{
    ...
    */
    ...
    public var tool_history:[ChoiceMessage]?
...
public class AiResponseFormat : Codable
{
    ...
    */
    ...
    public var type:ResponseFormat?
...
public class Tool : Codable
{
    ...
    */
    ...
    public var function:AiToolFunction?
...
public class ChoiceMessage : Codable
{
    ...
    */
    ...
    public var audios:[AiContent]?

    /**
    * Files produced by a tool call.
    */
    // @DataMember(Name="files")
    public var files:[AiContent]?
...
// @DataContract
public class AiToolFunction : Codable
{
    /**
...
*/
// @DataContract
public class Logprobs : Codable
{
    /**
    * A list of message content tokens with log probability information.
    */
    // @DataMember(Name="content")
    public var content:[LogprobItem] = []
...
public class AiAudioUrlContent : AiContent
{
    ...
    */
    ...
    public var audio_url:AiAudioUrl?
    ...
    required public init(from decoder: Decoder) throws {
        try super.init(from: decoder)
        let container = try decoder.container(keyedBy: CodingKeys.self)
        audio_url = try container.decodeIfPresent(AiAudioUrl.self, forKey: .audio_url)
    }

    public override func encode(to encoder: Encoder) throws {
        try super.encode(to: encoder)
        var container = encoder.container(keyedBy: CodingKeys.self)
        if audio_url != nil { try container.encode(audio_url, forKey: .audio_url) }
    }
}
...
*/
// @DataContract
public class ToolFunction : Codable
{
    /**
...
*/
// @DataContract
public class LogprobItem : Codable
{
    /**
    * The token.
    */
    ...
    */
    // @DataMember(Name="top_logprobs")
    public var top_logprobs:[LogprobItem] = []
...
// @DataContract
public class AiAudioUrl : Codable
{
    /**
