...
// @DataContract
class AiAudioUrl implements JsonSerializable
{
    public function __construct(
...
// @DataContract
class AiAudioUrlContent extends AiContent implements JsonSerializable
{
    /**
     * @param string $type
     */
    public function __construct(
        ...
        /** @var AiAudioUrl|null */
        public ?AiAudioUrl $audio_url=null
    ) {
        parent::__construct($type);
    }
    ...
    public function fromMap($o): void {
        parent::fromMap($o);
        if (isset($o['audio_url'])) $this->audio_url = JsonConverters::from('AiAudioUrl', $o['audio_url']);
    }
    ...
    {
        $o = parent::jsonSerialize();
        if (isset($this->audio_url)) $o['audio_url'] = JsonConverters::to('AiAudioUrl', $this->audio_url);
        return empty($o) ? new class(){} : $o;
    }
}
