...
pub const IReturnVoid = struct {
};

pub const IHasSessionId = struct {
    sessionId: ?[]const u8,
};

pub const IHasBearerToken = struct {
    bearerToken: ?[]const u8,
};

pub const IGet = struct {
};

pub const IPost = struct {
};

pub fn ICreateDb(comptime Table: type) type {
    _ = Table;
    return struct {
    };
}

pub fn IPatchDb(comptime Table: type) type {
    _ = Table;
    return struct {
    };
}

pub fn IDeleteDb(comptime Table: type) type {
    _ = Table;
    return struct {
    };
}
...
pub fn QueryDb(comptime T: type) type {
    _ = T;
    return struct {
    };
}
...
pub const TestNullableResponse = struct {
    id: ?i32,
    requiredId: i32,
    ids: ?[]i32,
    requiredIds: []i32,
    names: ?[][]const u8,
    requiredNames: [][]const u8,
    roomNumbers: ?[]i32,
    requiredRoomNumbers: []i32,
};
