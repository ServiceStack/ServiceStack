...
Namespace Global
    ...
    Namespace ServiceStack.AI
        ...
        Public Partial Class AiAudioUrlContent
            ...
            Public Overridable Property AudioUrl As AiAudioUrl
        End Class
        ...
        Public Partial Class AiCompletionUsage
            ...
            Public Overridable Property AcceptedPredictionTokens As Long

            '''<Summary>
            '''Audio input tokens generated by the model.
            '''</Summary>
            <DataMember(Name:="audio_tokens")>
            Public Overridable Property AudioTokens As Long

            '''<Summary>
            '''Tokens generated by the model for reasoning.
            '''</Summary>
            <DataMember(Name:="reasoning_tokens")>
            Public Overridable Property ReasoningTokens As Long

            '''<Summary>
            '''When using Predicted Outputs, the number of tokens in the prediction that did not appear in the completion.
            '''</Summary>
            <DataMember(Name:="rejected_prediction_tokens")>
            Public Overridable Property RejectedPredictionTokens As Long
        End Class
        ...
        Public Partial Class AiMessage
            ...
            Public Overridable Property ReasoningContent As String
            ...
            Public Overridable Property Images As List(Of AiContent)
        End Class
        ...
        Public Partial Class AiPromptUsage
            ...
            Public Overridable Property CachedTokens As Long
        End Class
        ...
        Public Partial Class AiUsage
            ...
            Public Overridable Property CompletionTokens As Long

            '''<Summary>
            '''Number of tokens in the prompt.
            '''</Summary>
            <DataMember(Name:="prompt_tokens")>
            Public Overridable Property PromptTokens As Long

            '''<Summary>
            '''Total number of tokens used in the request (prompt + completion).
            '''</Summary>
            <DataMember(Name:="total_tokens")>
            Public Overridable Property TotalTokens As Long
        ...
        Public Partial Class ChatResponse
            ...
            Public Overridable Property ToolHistory As List(Of ChoiceMessage)
        ...
        Public Partial Class Choice
            ...
            '''</Summary>
            <DataMember(Name:="logprobs")>
            Public Overridable Property Logprobs As Logprobs
        End Class
        ...
        Public Partial Class ChoiceAudio
            ...
            Public Overridable Property ExpiresAt As Long
        ...
        Public Partial Class ChoiceMessage
            ...
            Public Overridable Property Thinking As String
            ...
            Public Overridable Property Audios As List(Of AiContent)

            '''<Summary>
            '''Files produced by a tool call.
            '''</Summary>
            <DataMember(Name:="files")>
            Public Overridable Property Files As List(Of AiContent)
        ...
        Public Partial Class LogprobItem
            ...
            Public Overridable Property Logprob As Double

            '''<Summary>
            '''A list of integers representing the UTF-8 bytes representation of the token. Useful in instances where characters are represented by multiple tokens and their byte representations must be combined to generate the correct text representation. Can be `null` if there is no bytes representation for the token.
            '''</Summary>
            <DataMember(Name:="bytes")>
            Public Overridable Property Bytes As Byte() = New Byte(){}

            '''<Summary>
            '''List of the most likely tokens and their log probability, at this token position. In rare cases, there may be fewer than the number of requested `top_logprobs` returned.
            '''</Summary>
            <DataMember(Name:="top_logprobs")>
            Public Overridable Property TopLogprobs As List(Of LogprobItem) = New List(Of LogprobItem)
        End Class
        ...
        Public Partial Class Logprobs
            ...
            '''</Summary>
            <DataMember(Name:="content")>
            Public Overridable Property Content As List(Of LogprobItem) = New List(Of LogprobItem)
        End Class
        ...
        Public Partial Class Tool
            ...
            Public Overridable Property [Function] As AiToolFunction
        End Class
        ...
        Public Partial Class ToolCall
            ...
            '''</Summary>
            <DataMember(Name:="function")>
            Public Overridable Property [Function] As ToolFunction
        End Class
