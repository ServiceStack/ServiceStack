...
open ServiceStack.DataAnnotations
    ...
    type ToolFunction() = 
        ...
        member val Arguments:String = null with get,set
    ...
    type ToolCall() = 
        ...
        member val Function:ToolFunction = null with get,set
    ...
    type AiMessage() = 
        ...
        member val ReasoningContent:String = null with get,set

        ///<summary>
        ///Unix timestamp (in milliseconds) the message was generated.
        ///</summary>
        [<DataMember(Name="timestamp")>]
        member val Timestamp:Nullable<Int64> = new Nullable<Int64>() with get,set

        ///<summary>
        ///Images attached to the message. Folded into `content` parts before sending to a provider.
        ///</summary>
        [<DataMember(Name="images")>]
        member val Images:ResizeArray<AiContent> = null with get,set
    ...
    type AiToolFunction() = 
        ...
        member val Parameters:Dictionary<String, Object> = null with get,set
    ...
    type Tool() = 
        ...
        ///</summary>
        [<DataMember(Name="function")>]
        member val Function:AiToolFunction = null with get,set
    ...
    type ChoiceAudio() = 
        ...
        member val ExpiresAt:Int64 = new Int64() with get,set
    ...
    type ChoiceMessage() = 
        ...
        member val Thinking:String = null with get,set
        ...
        member val Audios:ResizeArray<AiContent> = null with get,set

        ///<summary>
        ///Files produced by a tool call.
        ///</summary>
        [<DataMember(Name="files")>]
        member val Files:ResizeArray<AiContent> = null with get,set
    ...
    type LogprobItem() = 
        ...
        member val Logprob:Double = new Double() with get,set

        ///<summary>
        ///A list of integers representing the UTF-8 bytes representation of the token. Useful in instances where characters are represented by multiple tokens and their byte representations must be combined to generate the correct text representation. Can be `null` if there is no bytes representation for the token.
        ///</summary>
        [<DataMember(Name="bytes")>]
        member val Bytes:Byte[] = null with get,set

        ///<summary>
        ///List of the most likely tokens and their log probability, at this token position. In rare cases, there may be fewer than the number of requested `top_logprobs` returned.
        ///</summary>
        [<DataMember(Name="top_logprobs")>]
        member val TopLogprobs:ResizeArray<LogprobItem> = null with get,set
    ...
    type Logprobs() = 
        ...
        ///</summary>
        [<DataMember(Name="content")>]
        member val Content:ResizeArray<LogprobItem> = null with get,set
    ...
    type Choice() = 
        ...
        member val Logprobs:Logprobs = null with get,set
    ...
    type AiCompletionUsage() = 
        ...
        member val AcceptedPredictionTokens:Int64 = new Int64() with get,set

        ///<summary>
        ///Audio input tokens generated by the model.
        ///</summary>
        [<DataMember(Name="audio_tokens")>]
        member val AudioTokens:Int64 = new Int64() with get,set

        ///<summary>
        ///Tokens generated by the model for reasoning.
        ///</summary>
        [<DataMember(Name="reasoning_tokens")>]
        member val ReasoningTokens:Int64 = new Int64() with get,set

        ///<summary>
        ///When using Predicted Outputs, the number of tokens in the prediction that did not appear in the completion.
        ///</summary>
        [<DataMember(Name="rejected_prediction_tokens")>]
        member val RejectedPredictionTokens:Int64 = new Int64() with get,set
    ...
    type AiPromptUsage() = 
        ...
        member val CachedTokens:Int64 = new Int64() with get,set
    ...
    type AiUsage() = 
        ...
        member val CompletionTokens:Int64 = new Int64() with get,set

        ///<summary>
        ///Number of tokens in the prompt.
        ///</summary>
        [<DataMember(Name="prompt_tokens")>]
        member val PromptTokens:Int64 = new Int64() with get,set

        ///<summary>
        ///Total number of tokens used in the request (prompt + completion).
        ///</summary>
        [<DataMember(Name="total_tokens")>]
        member val TotalTokens:Int64 = new Int64() with get,set
        ...
        member val Duration:Nullable<Int64> = new Nullable<Int64>() with get,set
    ...
    [<DataContract>]
    [<AllowNullLiteral>]
    type AiAudioUrlContent() = 
        inherit AiContent()
        ///<summary>
        ///The audio for this content.
        ///</summary>
        [<DataMember(Name="audio_url")>]
        member val AudioUrl:AiAudioUrl = null with get,set
    ...
    type ChatResponse() = 
        ...
        member val Cost:Nullable<Double> = new Nullable<Double>() with get,set

        ///<summary>
        ///The assistant and tool messages exchanged during the tool-execution loop, in order.
        ///</summary>
        [<DataMember(Name="tool_history")>]
        member val ToolHistory:ResizeArray<ChoiceMessage> = null with get,set
