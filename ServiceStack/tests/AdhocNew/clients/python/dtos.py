...
class AiMessage:
    ...
    images: Optional[List[AiContent]] = None
    """
...
class Tool:
    ...
    function: Optional[AiToolFunction] = None
    """
...
class ChoiceMessage:
    ...
    audios: Optional[List[AiContent]] = None
    """
    Audio generated by the model or produced by a tool call.
    """

    files: Optional[List[AiContent]] = None
    """
...
class LogprobItem:
    ...
    bytes_: bytes = field(metadata=config(field_name='bytes'), default=field(default_factory=list))
    """
    A list of integers representing the UTF-8 bytes representation of the token. Useful in instances where characters are represented by multiple tokens and their byte representations must be combined to generate the correct text representation. Can be `null` if there is no bytes representation for the token.
    """

    top_logprobs: List[LogprobItem] = field(default_factory=list)
    """
...
class Logprobs:
    ...
    content: List[LogprobItem] = field(default_factory=list)
    """
    A list of message content tokens with log probability information.
    """
...
class AiAudioUrlContent(AiContent):
    ...
    audio_url: Optional[AiAudioUrl] = None
    """
...
class ChatResponse:
    ...
    tool_history: Optional[List[ChoiceMessage]] = None
    """
