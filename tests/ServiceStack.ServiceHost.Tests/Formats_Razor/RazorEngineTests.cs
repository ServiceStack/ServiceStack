...
namespace ServiceStack.ServiceHost.Tests.Formats_Razor
{
	...
	public class RazorEngineTests
	{
		...
		{
			Razor.Compile(LayoutHtml, "TheLayout.cshtml");
		}
		...
		{
			const string template = "This is my sample template, Hello @Model.Name!";
			Razor.Compile(template, "simple");
			var result = Razor.Run(new { Name = "World" }, "simple");
		...
		public void Can_compile_simple_template_by_name_with_layout()
		{
			...
			var result2 = Razor.Run(new { Name = "World2" }, "simple");
		...
		public void Can_get_executed_template_by_name_with_layout()
		{
			...
			Razor.Compile(html, "simple2");

			var template = Razor.DefaultTemplateService.ExecuteTemplate(new { Name = "World" }, "simple2");
			...
			template = Razor.DefaultTemplateService.GetTemplate("simple2");
		...
		public void Can_get_executed_template_by_name_with_section()
		{
			...
			Razor.Compile(html, "simple3");

			var template = Razor.DefaultTemplateService.ExecuteTemplate(new { Name = "World" }, "simple3");
			...
			template = Razor.DefaultTemplateService.GetTemplate("simple3");
			Assert.That(template.Layout, Is.EqualTo("TheLayout.cshtml"));
