...
namespace AutorestClient
{
    ...
    public partial class AllowedAttributesOperations : IServiceOperations<ServiceStackAutorestClient>, IAllowedAttributesOperations
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse> GetWithHttpMessagesAsync(int aliased, string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
