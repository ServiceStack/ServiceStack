...
namespace AutorestClient
{
    ...
    public partial class HelloDateTimeOperations : IServiceOperations<ServiceStackAutorestClient>, IHelloDateTimeOperations
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<HelloDateTime>> GetWithHttpMessagesAsync(System.DateTime dateTime = default(System.DateTime), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<HelloDateTime>> DeleteWithHttpMessagesAsync(System.DateTime dateTime = default(System.DateTime), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
