...
namespace AutorestClient
{
    ...
    public static partial class HelloVoidOperationsExtensions
    {
            ...
            /// </param>
            public static object Get(this IHelloVoidOperations operations, string name = default(string), string format = "json")
            {
            ...
            /// </param>
            public static async Task<object> GetAsync(this IHelloVoidOperations operations, string name = default(string), string format = "json", CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Specifies response output format
            /// </param>
            public static object Delete(this IHelloVoidOperations operations, string name = default(string), string format = "json")
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> DeleteAsync(this IHelloVoidOperations operations, string name = default(string), string format = "json", CancellationToken cancellationToken = default(CancellationToken))
            {
