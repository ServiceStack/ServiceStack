...
namespace AutorestClient
{
    ...
    public static partial class HelloListOperationsExtensions
    {
            ...
            /// </param>
            public static IList<ListResult> Get(this IHelloListOperations operations, IList<string> names = default(IList<string>), string format = "json")
            {
            ...
            /// </param>
            public static async Task<IList<ListResult>> GetAsync(this IHelloListOperations operations, IList<string> names = default(IList<string>), string format = "json", CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Specifies response output format
            /// </param>
            public static IList<ListResult> Delete(this IHelloListOperations operations, IList<string> names = default(IList<string>), string format = "json")
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IList<ListResult>> DeleteAsync(this IHelloListOperations operations, IList<string> names = default(IList<string>), string format = "json", CancellationToken cancellationToken = default(CancellationToken))
            {
