...
namespace AutorestClient
{
    ...
    public partial class UpdateSessionOperations : IServiceOperations<ServiceStackAutorestClient>, IUpdateSessionOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<GetSessionResponse>> CreateWithHttpMessagesAsync(string customName, UpdateSession body = default(UpdateSession), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (customName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "customName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<GetSessionResponse>> PostWithHttpMessagesAsync(string customName, UpdateSession body = default(UpdateSession), string format = "json", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (customName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "customName");
