...
")));
        ...
        public void Does_execute_ProductsPage_with_default_layout()
        {
            ...
            Assert.That(TestUtils.NormalizeNewLines(html), Does.StartWith(TestUtils.NormalizeNewLines(@"<html>
<body id=root>
...
<tr><th>Beverages</th><td>Chang</td><td>$19.00</td></tr>")));
        }
...
StackTrace:
   at JsObjectExpression: {:qs.:id,:qs.:firstName}")));
