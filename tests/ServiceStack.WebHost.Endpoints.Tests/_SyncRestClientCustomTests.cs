...
namespace ServiceStack.WebHost.Endpoints.Tests
{
	...
	/// 
	/// Same as '_SyncRestClientTests' but calling services registerd with 'Routes.Add'
	/// </summary>
	public abstract class _SyncRestClientCustomTests : IDisposable
	{
		...
		public void Can_GET_GetFactorial_using_RestClient()
		{
			...
			var response = restClient.Get<GetFactorialResponse>("fact/3");
		...
		public void Can_GET_Movies_using_RestClient()
		{
			...
			var response = restClient.Get<MoviesResponse>("custom-movies");
		...
		public void Can_GET_single_Movie_using_RestClient()
		{
			...
			var response = restClient.Get<MovieResponse>("custom-movies/1");
		...
		public void Can_POST_to_add_new_Movie_using_RestClient()
		{
			...
			var response = restClient.Post<MovieResponse>("custom-movies", newMovie);
		...
		public void Can_DELETE_Movie_using_RestClient()
		{
			...
			var response = restClient.Post<MovieResponse>("custom-movies", newMovie);
			var createdMovie = response.Movie;
			response = restClient.Delete<MovieResponse>("custom-movies/" + createdMovie.Id);
	...
	[TestFixture]
	public class _JsonSyncRestClientCustomTests : _SyncRestClientCustomTests
	{
	...
	[TestFixture]
	public class _JsvSyncRestClientCustomTests : _SyncRestClientCustomTests
	{
		protected override IRestClient CreateRestClient()
		{
	...
	[TestFixture]
	public class _XmlSyncRestClientCustomTests : _SyncRestClientCustomTests
	{
		protected override IRestClient CreateRestClient()
		{
