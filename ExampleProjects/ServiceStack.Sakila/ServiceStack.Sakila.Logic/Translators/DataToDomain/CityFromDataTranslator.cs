...
{
	public class CityFromDataTranslator : ITranslator<City, DataAccess.DataModel.City>
	{
		public static readonly CityFromDataTranslator Instance = new CityFromDataTranslator();
