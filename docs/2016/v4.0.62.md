...
Born out of our initiative to improve ServiceStack's documentation, we sought out to create the best way
for developers to learn and explore different features in ServiceStack, the result is the ultimate 
collaborative tool for learning about and exploring C# and .NET libraries on NuGet from a zero install - 
modern browser. Gistlyn lets developers quickly learn C# and explore .NET libraries as a companion tool 
during development or on the go from the comfort of their iPad by going to [gistlyn.com](http://gistlyn.com). 
...
a complete UI for authoring your C# snippets that it saves directly to 
...
The best thing about Gistlyn collections is that they're just plain Github Gist's with a single `index.md` 
...
after introducing and explaining a feature you can provide a focused code example that Users can open on the
left which they can run to see it working, inspect its results and further modify the C# sample to 
continue exploring it even further themselves. 
...
### [Using ServiceStack.Client on .NET Core](https://github.com/ServiceStack/ServiceStack/blob/netcore/docs/pages/RunNetCoreApp.md)

We've published a step-by-step guide showing how to 
[Install ServiceStack.Client in a .NET Core App](https://github.com/ServiceStack/ServiceStack/blob/netcore/docs/pages/RunNetCoreApp.md)
...
[![](https://github.com/ServiceStack/ServiceStack/raw/netcore/docs/pages/images/11-dotnetrun.png)](https://github.com/ServiceStack/ServiceStack/blob/netcore/docs/pages/RunNetCoreApp.md)

## ServiceStack.Text is now Free!

To celebrate our initial release supporting .NET Core, we're now making all versions of 
[ServiceStack.Text](https://www.nuget.org/packages/ServiceStack.Text) 
completely free for commercial or non-commercial use. We've removed all technical restrictions
and have stopped selling licenses for ServiceStack.Text. By extension this also extends to our client 
...
[Stripe](https://github.com/ServiceStack/Stripe) which are also both free of restrictions.
