    ...
    private static Dictionary<Tuple<Dialect, int>, string> LoadDialectConnections()
    {
        ...
        { 
            return new Dictionary<Tuple<Dialect,int>, string> 
            {
                ...
                [Tuple.Create(Dialect.PostgreSql9, PostgreSqlDb.V9)]  = EnvironmentVariable(["PGSQL9_CONNECTION",  "PGSQL_CONNECTION"], "Server=localhost;Port=48301;User Id=test;Password=p@55wOrd;Database=test;Pooling=true;MinPoolSize=0;MaxPoolSize=200"),
                [Tuple.Create(Dialect.PostgreSql10, PostgreSqlDb.V10)] = EnvironmentVariable(["PGSQL10_CONNECTION", "PGSQL_CONNECTION"], "Server=localhost;Port=48302;User Id=test;Password=p@55wOrd;Database=test;Pooling=true;MinPoolSize=0;MaxPoolSize=200"),
                [Tuple.Create(Dialect.PostgreSql11, PostgreSqlDb.V11)] = EnvironmentVariable(["PGSQL11_CONNECTION", "PGSQL_CONNECTION"], "Server=localhost;Port=48303;User Id=test;Password=p@55wOrd;Database=test;Pooling=true;MinPoolSize=0;MaxPoolSize=200"),
