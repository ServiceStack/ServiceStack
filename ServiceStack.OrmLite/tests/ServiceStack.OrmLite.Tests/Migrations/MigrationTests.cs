...
public class MigrationTests : OrmLiteTestBase
{
    ...
    {
        Assert.That(OrmLiteUtils.MaskPassword("Server=host;User Id=u;Password=p@55wOrd;Database=test;Pooling=true;MinPoolSize=0;MaxPoolSize=200"),
            Is.EqualTo("Server=host;User Id=u;Password=***;Database=test;Pooling=true;MinPoolSize=0;MaxPoolSize=200"));
        Assert.That(OrmLiteUtils.MaskPassword("Server=host;Database=test;User Id=u;Password=p@55wOrd;MultipleActiveResultSets=True;"),
            Is.EqualTo("Server=host;Database=test;User Id=u;Password=***;MultipleActiveResultSets=True;"));
        Assert.That(OrmLiteUtils.MaskPassword("Server=host;Database=test;UID=u;Password=p@55wOrd;SslMode=none"),
