...
namespace ServiceStack.OrmLite.Tests.ConsoleApp
{
	/// <summary>
	/// Test ConsoleApp to run the Simple_CRUD_example() test with minimal dependencies.
	/// Make sure 'sqlite.so' or 'sqlite.dll' is in the same directory as the this .exe
	/// Since sqlite.* is a 32 bit lib, so does this app.
	/// </summary>
	class Program
	{
		static void Main(string[] args)
		{
			...
			useCase.TestFixtureSetUp();

			useCase.Simple_CRUD_example();
