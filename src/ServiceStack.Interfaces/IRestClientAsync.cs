...
namespace ServiceStack
{
	public interface IRestClientAsync : IDisposable
	{
        ...
        Task<HttpWebResponse> GetAsync<TResponse>(IReturnVoid requestDto);
        ...
        Task<HttpWebResponse> DeleteAsync<TResponse>(IReturnVoid requestDto);
        ...
        Task<HttpWebResponse> PostAsync<TResponse>(IReturnVoid requestDto);
        ...
        Task<HttpWebResponse> PutAsync<TResponse>(IReturnVoid requestDto);
