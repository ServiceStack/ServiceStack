    ...
    public class NativeTypesMetadata : INativeTypesMetadata
    {
        ...
        public MetadataTypesConfig GetConfig(NativeTypesBase req)
        {
            return new MetadataTypesConfig
            {
                ...
                DefaultTypeScriptImports = req.DefaultNamespaces ?? defaults.DefaultTypeScriptImports,
                DefaultSwiftImports = req.DefaultNamespaces ?? defaults.DefaultSwiftImports,
