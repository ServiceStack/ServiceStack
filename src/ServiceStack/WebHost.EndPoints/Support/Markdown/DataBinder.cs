...
namespace ServiceStack.WebHost.EndPoints.Support.Markdown
{
	...
	{
		public static Func<object, string> CompileDataBinder(Type type, string expr)
		{
		...
		public static Func<TModel, TProp> CompileDataBinder<TModel, TProp>(string expression)
		{
