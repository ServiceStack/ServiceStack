...
namespace ServiceStack.Auth
{
    ...
    public class MicrosoftGraphAuthProvider : OAuth2Provider
    {
            ...
            : base(appSettings, Realm, Name)
        {
            ...
            LogoUri = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 20 20'%3E%3Cpath d='M11.55 21H3v-8.55h8.55V21zM21 21h-8.55v-8.55H21V21zm-9.45-9.45H3V3h8.55v8.55zm9.45 0h-8.55V3H21v8.55z' fill='currentColor'/%3E%3C/svg%3E";
            NavItem = new NavItem {
                Href = "/auth/" + Name,
