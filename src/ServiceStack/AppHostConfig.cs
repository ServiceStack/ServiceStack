...
namespace ServiceStack
{
    ...
    {
        private static ILog log = LogManager.GetLogger(typeof(AppHostConfig));
        ...
        private static AppHostConfig instance;
        public static AppHostConfig Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new AppHostConfig
                    {
