...
{
	public class JsonAsyncServiceClient
		: AsyncServiceClientBase
	{
		public JsonAsyncServiceClient()
		{
		}

		public JsonAsyncServiceClient(string baseUri) 
		{
			this.BaseUri = baseUri.WithTrailingSlash() + "Json/";
		}

		public JsonAsyncServiceClient(string syncReplyBaseUri, string asyncOneWayBaseUri) 
